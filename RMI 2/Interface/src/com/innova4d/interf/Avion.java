...
public class Avion extends Vehiculo implements Serializable, ObjectInputValidation {
    ...
    /**
     * Constructor publico por defacto para la creacion de un Avion
     * @param id Con la cual asociar el avion
    ...
    /**
     * Metodo de apoyo para deserializar el avion
     * @param in ObjectStream encargado de recrear el avion
     */
    ...
    /**
     * Metodo de apoyo para serializar el avion
     * @param out ObjectStream encargado de convertir el avion
     */
