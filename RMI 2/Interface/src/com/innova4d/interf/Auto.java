...
/**
 * Implementacion concreta de Vehiculo, en forma de Auto, que permite ser serializado
 */
public class Auto extends Vehiculo implements Serializable, ObjectInputValidation {
	
	// Serial Unique ID 
	private static final long serialVersionUID = 2L;

    /**
     * Constructor publico por defacto para la creacion de un Auto
     * @param id Con la cual asociar el auto
     * @param x Carril que ocupa en la pista
     * @param y Posicion que ocupa en el carril
     * @param v Velocidad del auto
     */
	public Auto(String id, int x, int y, int v) throws RemoteException {
		this.setId(id);
        this.setX(x);
		this.setY(y);
        this.setVelocidad(v);
    ...
    /**
     * Metodo de apoyo para deserializar el auto
     * @param in ObjectStream encargado de recrear el auto
     */
    ...
    /**
     * Metodo de apoyo para serializar el auto
     * @param out ObjectStream encargado de convertir el auto
     */
